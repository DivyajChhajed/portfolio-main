...
const SkillsList = () => {
  ...
  const skills = {
    "Full-Stack Web Development": [
      "Developed full-stack websites and web apps",
    ...
    "Design-to-Code": [
      "Converting Figma designs into exact code replicas",
      "Interactive Web-pages with modern designs & animations",
      "Responsive web design",
    ],
    "Generative AI & Machine Learning": [
      "AI-based solutions & web-apps",
      "Integrating LLMs based APIs",
      "RAG, Chatbots and virtual assistants",
    ],
  };
